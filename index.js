...
function computerSquence(){
  for(let i = 0; i < comp.length; i++) {
    if(comp[i] === 0) {
      ...
      setTimeout(function(){ document.getElementById('yellow').classList.remove('active') }, 1000);
      setTimeout(function(){ document.getElementById('blue').classList.remove('active') }, 1000);
      setTimeout(function(){ document.getElementById('red').classList.remove('active') }, 1000);
      setTimeout(function(){ document.getElementById('green').classList.remove('active') }, 1000);
    }
    if(comp[i] === 1) {
